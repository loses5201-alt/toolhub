  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        globIgnores: ['**/pdf-vendor*.js', '**/sheet-vendor*.js', '**/exif-vendor*.js', '**/heic-vendor*.js', '**/qr-vendor*.js', '**/zip-vendor*.js', '**/bg-vendor*.js', '**/ocr-vendor*.js', '**/gif-vendor*.js', '**/barcode-vendor*.js', '**/yaml-vendor*.js'],
        runtimeCaching: [
          {
    ...
    rollupOptions: {
      output: {
        ...
        manualChunks(id: string) {
          ...
          // js-yaml(JSON↔YAML)拆獨立 chunk + 不預快取(用到才載)
