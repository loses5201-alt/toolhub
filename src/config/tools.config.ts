...
export const tools: ToolDef[] = [
  ...
  },
  {
    ...
    category: 'workshop',
    description:
      '收到 .docx 卻沒裝 Word / Office?直接打開看內容與文件資訊(標題、作者、建立 / 修改日期、頁數、字數),並一鍵轉成乾淨純文字或 Markdown(保留標題、清單、粗體 / 斜體、表格),貼進筆記、部落格、聊天室都方便。.docx 本質是 ZIP,用瀏覽器內建 JSZip 解壓後以純函式解析 document.xml / core.xml。履歷、合約、報告常含個資,線上 Word 轉檔網站卻要你整份上傳;這支全程在你瀏覽器解析,不連網、不上傳,且不載入內嵌的遠端圖片 / 追蹤連結。與 EPUB 電子書檢視器、.eml 郵件檢視器同屬「打開檔案看內容」家族。',
    keywords: [
      'docx',
      'word',
      'word 檔',
    ...
    icon: '📝',
    loader: () => import('@/tools/docx-viewer/Index.vue'),
  },
  {
    id: 'bookmarks-clean',
    name: '瀏覽器書籤整理',
