...
export const tools: ToolDef[] = [
  ...
  },
  {
    ...
    category: 'workshop',
    description:
      '貼上一串數字(可直接從 Excel 一欄貼上),算出平均、中位數、眾數、樣本/母體標準差與變異數、四分位數、IQR、偏度峰度、變異係數、幾何/調和平均,並自動標出離群值,畫出直方圖與盒鬚圖 —— 四分位採 Excel QUARTILE.INC、偏度峰度採 Excel SKEW/KURT。免開 Excel/SPSS,全程在你瀏覽器計算,資料不上傳、無廣告。',
    keywords: [
      '描述統計',
      '敘述統計',
      '統計',
    ...
    icon: '📈',
    loader: () => import('@/tools/descriptive-stats/Index.vue'),
  },
  {
    id: 'table-merge',
    name: '表格合併 / VLOOKUP',
