...
export const tools: ToolDef[] = [
  ...
  },
  {
    ...
    name: 'PDF 工坊',
    category: 'workshop',
    description: '合併、刪頁/重排、圖片↔PDF、取出文字、加浮水印、加頁碼、簽名、壓縮 —— 全程在你瀏覽器處理,不上傳機密文件、無廣告、不限檔數。',
    keywords: ['pdf', '合併', '分割', '刪頁', '重排', '頁面', '圖片轉pdf', 'pdf轉圖片', 'pdf轉jpg', '掃描', '轉檔', '擷取', '抽頁', '組合', '浮水印', '加註', '證件', '防盜用', 'watermark', '取出文字', '抽文字', '複製文字', '純文字', 'pdf轉文字', 'pdf轉文字檔', '文字層', '頁碼', '加頁碼', '編號', '頁數', '第幾頁', 'page number', '簽名', '簽署', '簽章', '手寫簽名', '電子簽名', 'pdf簽名', '蓋章', '合約簽名', 'sign', 'signature', '壓縮', '縮小', '減肥', '檔案太大', '太大', '寄不出去', 'compress', '變小'],
    icon: '📄',
