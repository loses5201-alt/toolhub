...
export const tools: ToolDef[] = [
  ...
  },
  {
    ...
    name: 'PDF 工坊',
    category: 'workshop',
    description: '合併、刪頁/重排、圖片↔PDF、取出文字、加浮水印、加頁碼 —— 全程在你瀏覽器處理,不上傳機密文件、無廣告、不限檔數。',
    keywords: ['pdf', '合併', '分割', '刪頁', '重排', '頁面', '圖片轉pdf', 'pdf轉圖片', 'pdf轉jpg', '掃描', '轉檔', '擷取', '抽頁', '組合', '浮水印', '加註', '證件', '防盜用', 'watermark', '取出文字', '抽文字', '複製文字', '純文字', 'pdf轉文字', 'pdf轉文字檔', '文字層', '頁碼', '加頁碼', '編號', '頁數', '第幾頁', 'page number'],
    icon: '📄',
