...
export const tools: ToolDef[] = [
  ...
  {
    id: 'json-query',
    name: 'JSON 查詢(JSONPath)',
    category: 'workshop',
    description:
      '從又大又深的 API 回應、設定檔、log JSON 裡,用 JSONPath 路徑直接撈出要的值,免一層層展開 —— 支援 .key、[索引]、[*]、.. 遞迴、切片與 [?(@.price<10)] 過濾。API 回應常含 token、個資,本工具全程在你瀏覽器執行、不上傳,且自刻解析器不用 eval。',
    keywords: [
      'json',
      'jsonpath',
      'json path',
