...
export const tools: ToolDef[] = [
  ...
  },
  {
    ...
    name: 'CSS 顏色名稱查詢',
    category: 'workshop',
    description: '輸入任何 HEX / rgb() / hsl() / 顏色英文名,告訴你「這個顏色叫什麼」—— 完全相符就給名稱,否則用感知距離(redmean)列出最接近的 148 個 CSS 標準命名色。全程在你瀏覽器計算、不連網。',
    keywords: [
      '顏色名稱',
      '色名',
      '顏色叫什麼',
    ...
    icon: '🏷️',
    loader: () => import('@/tools/color-name/Index.vue'),
  },
  {
    id: 'gradient-maker',
    name: 'CSS 漸層產生器',
  ...
  },
  {
    ...
    category: 'workshop',
    description:
      '把 SOAP 回應 / RSS / pom.xml / Android 版面 / 各式 XML 設定檔轉成方便程式處理的 JSON,或反向還原成 XML —— 屬性轉 @ 前綴鍵、同名子元素合併成陣列、文字放 #text,可選把數字/true/false 轉型。全程在你瀏覽器處理、不上傳。',
    keywords: [
      'xml',
      'json',
      'xml轉json',
    ...
    icon: '🔁',
    loader: () => import('@/tools/xml-json/Index.vue'),
  },
  {
    id: 'css-format',
    name: 'CSS 格式化 / 壓縮',
  ...
  },
  {
    ...
    category: 'workshop',
    description:
      '開啟存下來的 .eml 信件檔(或在 Gmail/Outlook 選「顯示原始郵件」存的檔),直接看清楚主旨、寄件者、收件者、日期、內文與附件 —— 主旨/寄件者的 =?UTF-8?B?…?= 亂碼自動還原,quoted-printable / base64 內文自動解碼,附件可一鍵下載。為防隱私外洩,HTML 內文不直接渲染(不載入遠端追蹤圖片),只呈現原始碼。全程在你瀏覽器解析,信件內容不連網、不上傳。與郵件來源檢視(防冒名)、.ics 行事曆檢視器互補。',
    keywords: [
      'eml',
      '郵件',
      '信件',
    ...
    icon: '📨',
    loader: () => import('@/tools/eml-viewer/Index.vue'),
  },
  {
    id: 'asn1-decode',
    name: 'ASN.1 / DER 解碼器',
    category: 'workshop',
    description:
      '貼上 PEM / base64 / hex 的 DER 編碼(X.509 憑證、公私鑰、CSR…),拆解成看得懂的 ASN.1 結構樹 —— SEQUENCE、INTEGER、OID、BIT STRING 一層層攤開,常見 OID(簽章演算法、公鑰型別、commonName、subjectAltName 等)自動標名稱,內嵌 DER 會再往內解一層。憑證與金鑰是高度敏感資料,線上解碼器卻常要你貼到別人的伺服器;這支全程在你瀏覽器解析,不連網、不上傳。',
    keywords: [
      'asn1',
      'asn.1',
      'der',
    ...
    icon: '🔐',
    loader: () => import('@/tools/asn1-decode/Index.vue'),
  },
  {
    id: 'cert-viewer',
    name: 'X.509 憑證檢視器',
    category: 'workshop',
    description:
      '貼上 SSL/TLS 憑證(PEM / .crt / .cer),翻成白話欄位 —— 發給誰(主體)、誰簽的(簽發者)、有效期與到期狀態(已過期/快到期/還有幾天)、適用哪些網域(SAN)、公鑰型別與長度、簽章演算法、各擴充,並算 SHA-256 指紋供核對。憑證雖公開,線上解析器卻常一併要你貼私鑰;這支全程在你瀏覽器解析,不連網、不上傳。需要更底層結構用「ASN.1 / DER 解碼器」。',
    keywords: [
      '憑證',
      'certificate',
      'cert',
    ...
    icon: '📜',
    loader: () => import('@/tools/cert-viewer/Index.vue'),
  },
  {
    id: 'mbox-split',
    name: 'mbox 信箱分割器',
    category: 'workshop',
    description:
      'Google Takeout、Thunderbird、Apple Mail 匯出的信箱常是一個動輒上 GB 的 mbox 檔,所有信件擠在一起 —— 這支幫你分割成一封封獨立郵件,列出主旨/寄件者/日期,可搜尋,並單封或整批下載成標準 .eml(用「.eml 郵件檢視器」開或匯入其他信箱)。信箱裡全是隱私,線上工具卻要你整個上傳;這支全程在你瀏覽器處理,不連網、不上傳。',
    keywords: [
      'mbox',
      '信箱',
      '郵件',
    ...
    icon: '🗂️',
    loader: () => import('@/tools/mbox-split/Index.vue'),
  },
  {
    id: 'epub-viewer',
    name: 'EPUB 電子書檢視器',
    category: 'workshop',
    description:
      '打開 .epub 電子書,不必裝閱讀軟體就能看書名、作者、出版社、出版日期、ISBN、分類與封面,整理書庫或確認檔案內容很方便。列出完整目錄與閱讀順序,點章節即可把內文轉成乾淨純文字離線閱讀,並估算全書字數。為保護隱私,內文以純文字呈現,不載入電子書內嵌的遠端圖片 / 追蹤連結。全程在你瀏覽器解析,電子書不上傳、不連網 —— 線上 EPUB 檢視器多半要你上傳整本書,這支不會。與 .eml 郵件檢視器、mbox 信箱分割器同屬「打開檔案看內容」家族。',
    keywords: [
      'epub',
      'epub 檢視',
      'epub viewer',
    ...
    icon: '📖',
    loader: () => import('@/tools/epub-viewer/Index.vue'),
  },
  {
    id: 'bookmarks-clean',
    name: '瀏覽器書籤整理',
    category: 'workshop',
    description:
      '開啟 Chrome / Edge / Firefox / Safari「匯出書籤」存的 .html,把巢狀資料夾攤開成清晰清單(標題、網域、所在資料夾、加入日期),一鍵找出重複網址(忽略尾斜線 / 錨點 / 大小寫網域差異),關鍵字搜尋標題 / 網址 / 資料夾,並匯出成 Markdown(貼到筆記軟體)或 CSV(用 Excel 整理 / 備份)。書籤透露你的興趣與常用服務,屬個人資料;全程在你瀏覽器處理、完全不上傳、不連網。與 vCard 通訊錄檢視、.eml 郵件檢視器同屬「打開檔案看內容」家族。',
    keywords: [
      '書籤',
      '書籤整理',
      'bookmark',
    ...
    icon: '🔖',
    loader: () => import('@/tools/bookmarks-clean/Index.vue'),
  },
  {
    id: 'feed-viewer',
    name: 'RSS / Atom 訂閱源檢視器',
    category: 'workshop',
    description:
      '開啟存下來的訂閱源 XML(RSS 2.0 / Atom / RSS 1.0·RDF),離線就能讀文章清單 —— 標題、連結、發布日期、作者、摘要、分類,可關鍵字搜尋、依日期排序、匯出 Markdown。摘要一律轉成乾淨純文字並過濾標籤,不載入內嵌的遠端追蹤圖片或廣告。適合在連去原站之前先看內容,或封存喜歡的部落格 / 新聞 / Podcast feed。全程在你瀏覽器解析,完全不上傳、不連網。與 .eml 郵件檢視器、EPUB 電子書檢視器、瀏覽器書籤整理同屬「打開檔案看內容」家族。',
    keywords: [
      'rss',
      'atom',
      'feed',
    ...
    icon: '📡',
    loader: () => import('@/tools/feed-viewer/Index.vue'),
  },
  {
    id: 'opml-viewer',
    name: 'OPML 訂閱清單檢視器',
    category: 'workshop',
    description:
      '開啟 RSS 閱讀器(Feedly / Inoreader / NetNewsWire…)「匯出訂閱」存的 .opml,把巢狀資料夾攤成清晰的訂閱清單(標題、Feed 網址、所在資料夾),一鍵找出重複的 feed(忽略尾斜線 / 大小寫),關鍵字搜尋,並匯出 Markdown、CSV(Excel 備份)或縮排純文字大綱。換閱讀器或備份訂閱時最好用。OPML 也是大綱 / 心智圖工具的交換格式,同樣可開。清單透露你的閱讀偏好,屬個人資料;全程在你瀏覽器處理、完全不上傳、不連網。與 RSS 訂閱源檢視器、瀏覽器書籤整理同屬「打開檔案看內容」家族。',
    keywords: [
      'opml',
      '訂閱清單',
      '訂閱備份',
    ...
    icon: '🗂️',
    loader: () => import('@/tools/opml-viewer/Index.vue'),
  },
  {
    id: 'geojson-inspect',
    name: 'GeoJSON 檢視 / 分析',
    category: 'workshop',
    description:
      '開啟 QGIS / Leaflet / Mapbox / OpenStreetMap 匯出、或政府開放資料的 .geojson,一眼看到幾何型別分布(Point / LineString / Polygon…)、feature 數、座標點總數、整體邊界框(bbox)、線段總長與面積合計,並逐 feature 列出型別 / 點數 / 長度 / 面積 / 屬性欄位,可依點數 / 長度 / 面積排序。一份 GeoJSON 常有上千個 feature,用文字編輯器打開只是一坨座標。長度與面積採球面近似(WGS84),面積自動扣除多邊形的洞。座標可能含敏感地點;全程在你瀏覽器解析、完全不上傳、不連網。',
    keywords: [
      'geojson',
      'geo json',
      '地理',
    ...
    icon: '🗺️',
    loader: () => import('@/tools/geojson-inspect/Index.vue'),
  },
  {
    id: 'wkt-convert',
    name: 'WKT ⇆ GeoJSON 轉換',
    category: 'workshop',
    description:
      '空間資料庫(PostGIS / MySQL / SQL Server / Oracle Spatial)用 WKT 文字表示幾何(POINT (121 25)、POLYGON ((…))),前端地圖(Leaflet / Mapbox)與開放資料用 GeoJSON。本工具雙向互轉:把資料庫查出的 WKT 貼進地圖,或把 GeoJSON 存回資料庫。支援 POINT / LINESTRING / POLYGON / MULTI* / GEOMETRYCOLLECTION、EMPTY、Z/M 維度(高程保留為第三軸),容忍 EWKT 的 SRID 前綴;WKT 可一行一筆批次轉成 FeatureCollection。全程在你瀏覽器處理、完全不上傳、不連網。與 GeoJSON 檢視 / 分析互補。',
    keywords: [
      'wkt',
      'well-known text',
      'ewkt',
    ...
    icon: '📐',
    loader: () => import('@/tools/wkt-convert/Index.vue'),
  },
  {
    id: 'vcf-viewer',
    name: 'vCard 通訊錄檢視 / 分割器',
    category: 'workshop',
    description:
      'Google 通訊錄、iCloud、Android 匯出的 .vcf 常是一個檔塞了上百張名片,用記事本開全是欄位代碼 —— 這支幫你列成一張張看得懂的名片(姓名/電話/Email/公司/職稱),可搜尋,單張另存 .vcf 或整批匯出成 CSV(用 Excel 開、做合併列印)。支援 vCard 2.1 / 3.0 / 4.0,含折行還原與 QUOTED-PRINTABLE 編碼姓名。通訊錄全是親友隱私,線上工具卻要你整本上傳;這支全程在你瀏覽器解析,不連網、不上傳。',
    keywords: [
      'vcard',
      'vcf',
      '通訊錄',
    ...
    icon: '👥',
    loader: () => import('@/tools/vcf-viewer/Index.vue'),
  },
  {
    id: 'geo-coord',
    name: 'GPS 座標轉換 / 距離',
  ...
  },
  {
    ...
    category: 'workshop',
    description:
      '給兩個座標,算出「從 A 該往哪個方向走才會到 B」—— 起始方位角、到達方位角、反方位角、羅盤方位名(中英 4/8/16 方位)與大圓距離,附羅盤指針示意;也能單獨把方位角換成方位名。登山定向、天線/衛星小耳朵對準、航海飛行航向、無人機航點用得到。給的是真北方位(羅盤讀磁北,需留意磁偏角)。全程在你瀏覽器計算,不連網、不上傳。',
    keywords: [
      '方位角',
      '方位',
      'bearing',
    ...
    icon: '↗️',
    loader: () => import('@/tools/geo-bearing/Index.vue'),
  },
  {
    id: 'gpx-analyze',
    name: 'GPX / KML 軌跡分析',
    category: 'workshop',
    description:
      '開啟 Garmin / Strava / Komoot / 手機運動 App 或 Google Earth 匯出的 .gpx / .kml 軌跡,一眼看到總距離、累計爬升 / 下降、海拔範圍、總時間、配速、均速 / 最高速度,並畫出路線形狀與海拔剖面預覽。可調海拔雜訊過濾排除 GPS 抖動讓爬升估算更準。軌跡是你的位置紀錄(高度敏感),本工具全程在你瀏覽器計算、完全不上傳、不連網 —— 線上軌跡分析網站多半要你上傳整份紀錄。與座標換算、方位角計算互補。',
    keywords: [
      'gpx',
      'kml',
      '軌跡',
    ...
    icon: '🛰️',
    loader: () => import('@/tools/gpx-analyze/Index.vue'),
  },
  {
    id: 'text-similarity',
    name: '文字相似度比對',
  ...
  },
  {
    ...
    name: 'JSON 轉 Java',
    category: 'workshop',
    description: '貼上 API 回應或任何 JSON,自動推斷出 Java class 或 record —— 可選 Jackson(@JsonProperty)或 Gson(@SerializedName)標註,屬性採 camelCase 並自動補標註,巢狀物件各自成類別、陣列合併欄位,一律用裝箱型別好放 null。寫 Java 後端 / Android 免手刻型別。與 JSON 轉 TypeScript / Go / Python / Rust / C# / Kotlin 互補;全程在你瀏覽器,含密鑰回應不上傳。',
    keywords: ['json', 'java', 'pojo', 'class', 'record', 'jackson', 'gson', 'jsonproperty', 'serializedname', '型別', 'json轉java', 'json to java', '產生類別', 'spring', 'android', 'dto', '後端', 'lombok'],
    icon: '☕',
  ...
  {
    id: 'protobuf-decode',
    name: 'Protobuf 二進位解碼器',
    category: 'workshop',
    description:
      '貼上 hex / base64 的 Protobuf 位元組(沒有 .proto schema 也行),依 wire format 拆成「欄位編號 + wire type + 值」的結構樹 —— 等同 protoc --decode_raw,免裝 protoc。varint 同時給有號 / zigzag / bool 詮釋,64/32-bit 給 int / float / double,length-delimited 自動試解成巢狀訊息,否則當字串 / bytes。gRPC 抓包資料常含 token 與個資,線上解碼器卻要你上傳;這支全程在你瀏覽器解析,不連網、不上傳。與 ASN.1 / DER 解碼器、JSON 轉 Protobuf 互補。',
    keywords: [
      'protobuf',
      'proto',
      'protobuf 解碼',
    ...
    icon: '🔌',
    loader: () => import('@/tools/protobuf-decode/Index.vue'),
  },
  {
    id: 'cbor-decode',
    name: 'CBOR 解碼器',
    category: 'workshop',
    description:
      '貼上 hex / base64 的 CBOR(RFC 8949)二進位,拆成可讀的結構樹 —— 整數、byte / text 字串、陣列、map、標籤(tag)、浮點與布林 / null 一層層攤開。WebAuthn / passkey 認證資料、COSE 金鑰、CTAP、IoT 訊息常用 CBOR;支援定長與不定長字串 / 陣列 / map、float16/32/64,well-known 標籤標名稱,bignum 還原整數。這些資料常含憑證金鑰個資,線上解碼器卻要你上傳;這支全程在你瀏覽器解析,不連網、不上傳。與 Protobuf 二進位解碼器、ASN.1 / DER 解碼器互補。',
    keywords: [
      'cbor',
      'cbor 解碼',
      'cbor decode',
    ...
    icon: '📦',
    loader: () => import('@/tools/cbor-decode/Index.vue'),
  },
  {
    id: 'msgpack-decode',
    name: 'MessagePack 解碼器',
    category: 'workshop',
    description:
      '貼上 hex / base64 的 MessagePack 二進位,依官方 spec 拆成可讀的結構樹 —— 整數、float、字串、bin、陣列、map 一層層攤開。除錯 Redis、msgpack-rpc、遊戲 / IoT 即時通訊與許多用 MessagePack 的 API 常用;支援全部格式族、64 位元整數(BigInt 不失真)與 timestamp 擴充(自動換成可讀時間)。封包常含 token 個資,線上解碼器卻要你上傳;這支全程在你瀏覽器解析,不連網、不上傳。與 CBOR 解碼器、Protobuf 二進位解碼器互補。',
    keywords: [
      'messagepack',
      'msgpack',
      'message pack',
    ...
    icon: '📦',
    loader: () => import('@/tools/msgpack-decode/Index.vue'),
  },
  {
    id: 'bencode-decode',
    name: 'Bencode / .torrent 解碼器',
    category: 'workshop',
    description:
      '貼上 bencode 文字或 .torrent 檔的 hex / base64,拆成可讀的結構樹 —— 不必開 BitTorrent 軟體就能看一個種子到底包含哪些檔案、單檔大小、piece 大小、連去哪些 tracker,下載來路不明的種子前先檢查內容。頂層含 info 時自動算出 info-hash(SHA-1 = v1、SHA-256 = v2)供核對 magnet 連結。二進位字串(如 pieces 雜湊)以位元組長度顯示不爆版。全程在你瀏覽器解析,不連網、不上傳。',
    keywords: [
      'bencode',
      'torrent',
      '.torrent',
    ...
    icon: '🧲',
    loader: () => import('@/tools/bencode-decode/Index.vue'),
  },
  {
    id: 'php-serialize',
    name: 'PHP serialize() 解碼器',
    category: 'workshop',
    description:
      '貼上 WordPress / Laravel / Drupal 資料庫裡那一坨 PHP serialize() 字串(像 a:2:{…}、O:8:"stdClass":…),拆成看得懂的結構樹,並可一鍵轉成乾淨 JSON。正確以 UTF-8 位元組長度解析(中文不會錯位),支援 array、object(含 protected / private 屬性可見性)、reference、自訂序列化,並偵測尾端多餘資料,也支援 base64 包裝。序列化內容常含帳號、密碼雜湊與個資 —— 全程在你瀏覽器解析,不連網、不上傳。與 JSON 美化 / 修復、YAML、CBOR / MessagePack 解碼器互補。',
    keywords: [
      'php',
      'serialize',
      'unserialize',
    ...
    icon: '🐘',
    loader: () => import('@/tools/php-serialize/Index.vue'),
  },
  {
    id: 'plist-viewer',
    name: 'Apple plist 檢視器',
    category: 'workshop',
    description:
      '開啟 iOS / macOS 的 .plist 檔(二進位 bplist00 或 XML 皆可),拆成看得懂的結構樹並一鍵轉乾淨 JSON。App 偏好設定、Info.plist、iCloud / iTunes 備份、描述檔(.mobileconfig)內層、NSKeyedArchiver 封存常用 plist;二進位的用文字編輯器打開只會看到亂碼。支援 dict / array / 字串 / 整數 / 浮點 / 布林 / data / 日期 / UID。plist 常藏帳號、權杖、裝置 UDID 等隱私 —— 全程在你瀏覽器解析,不連網、不上傳。與 CBOR / MessagePack / Bencode / ASN.1 解碼器互補。',
    keywords: [
      'plist',
      'property list',
      'apple plist',
    ...
    icon: '🍏',
    loader: () => import('@/tools/plist-viewer/Index.vue'),
  },
  {
    id: 'pickle-disasm',
    name: 'Python pickle 反組譯器',
    category: 'workshop',
    description:
      '只讀不執行!把 Python 的 .pkl / .pickle 逐個 opcode 拆給你看(等同 pickletools.dis),並在不呼叫任何建構式的前提下重建出 list / dict / tuple / set / 數字 / 字串等結構。pickle.load() 會在反序列化時執行資料指定的程式碼,載入來路不明的 .pkl(ML 模型權重、Django / Celery 任務、快取常見)等同執行陌生程式 —— 本工具讓你先看清楚它會 import 哪些模組、呼叫哪些函式(GLOBAL / REDUCE 標紅警示)。支援 protocol 0~5;全程在你瀏覽器解析,不連網、不上傳。',
    keywords: [
      'pickle',
      'pkl',
      'pickle 反組譯',
    ...
    icon: '🥒',
    loader: () => import('@/tools/pickle-disasm/Index.vue'),
  },
  {
    id: 'font-inspect',
    name: '字型檔檢視器',
    category: 'workshop',
    description:
      '打開 .ttf / .otf / .ttc 不必裝任何軟體,就能看到這是什麼字型(家族 / 樣式 / 完整名稱)、版本、製造商 / 設計師、著作權與授權條款,重點是「是否允許嵌入(fsType)」—— 把字型放進 PDF / 簡報 / 網頁前先確認授權,避免侵權。也顯示字重 / 寬度 / 斜體 / 等寬、每 em 單位、字符數量、建立日期、資料表清單,並即時預覽字型外觀。WOFF / WOFF2 請先轉成 .ttf / .otf。字型檔全程在你瀏覽器解析,不連網、不上傳。',
    keywords: [
      'font',
      '字型',
      '字體',
    ...
    icon: '🔤',
    loader: () => import('@/tools/font-inspect/Index.vue'),
  },
  {
    id: 'pe-inspect',
    name: 'EXE / DLL 檢視器',
    category: 'workshop',
    description:
      '下載到一個 .exe / .dll 先別急著執行,先看清楚它是什麼:32 還是 64 位元、給哪種 CPU(x86 / x64 / ARM)、編譯時間、是 GUI 還是命令列程式、有沒有開 ASLR / DEP / CFG 等安全防護、是否帶數位簽章、會去呼叫哪些系統 DLL(可推測它大概會做什麼),並標出「可寫 + 可執行」等加殼 / 自我修改的可疑特徵。本工具不是防毒、也不驗證簽章有效性,只幫你「執行前先看清楚」。檔案全程在你瀏覽器解析,不連網、不上傳、不執行。',
    keywords: [
      'exe',
      'dll',
      'pe',
    ...
    icon: '🪟',
    loader: () => import('@/tools/pe-inspect/Index.vue'),
  },
  {
    id: 'elf-inspect',
    name: 'ELF 執行檔檢視器',
    category: 'workshop',
    description:
      '拿到來路不明的 Linux / BSD 執行檔或 .so,不必在機器上跑就能看清楚:32 還是 64 位元、大小端、給哪種 CPU(x86-64 / ARM64 / RISC-V…)、是執行檔還是共享函式庫、是不是 PIE、有沒有開 NX / RELRO 防護(等同 checksec)、動態還是靜態連結、會用到哪些共享函式庫(DT_NEEDED)、動態載入器是誰、有沒有被 strip 掉符號,並標出 RWX 段等加殼 / 自我修改特徵。不是防毒,只幫你「執行前先看清楚」。檔案全程在你瀏覽器解析,不連網、不上傳、不執行。',
    keywords: [
      'elf',
      'linux 執行檔',
      '執行檔',
    ...
    icon: '🐧',
    loader: () => import('@/tools/elf-inspect/Index.vue'),
  },
  {
    id: 'json-to-dart',
    name: 'JSON 轉 Dart',
  ...
  },
  {
    ...
    category: 'workshop',
    description:
      '在影格數與時間碼(HH:MM:SS:FF)之間互轉,支援 23.976 / 24 / 25 / 29.97 / 30 / 50 / 59.94 / 60 fps 與 drop-frame(掉幀,29.97 / 59.94),並算出實際時間長度。採經典 SMPTE 演算法。剪輯、字幕、套對必備。全程在你瀏覽器計算,不上傳。',
    keywords: [
      '時間碼',
      '時間嗎',
      'timecode',
    ...
    icon: '🎬',
    loader: () => import('@/tools/timecode/Index.vue'),
  },
  {
  ...
  },
  {
    ...
    category: 'workshop',
    description:
      '輸入兩個顏色,算出人眼覺得差多少 —— 換到感知均勻的 CIE L*a*b* 空間,給出 ΔE00(CIEDE2000,業界標準)、ΔE94、ΔE76 三種色差與白話解讀。品牌色把關、印刷打樣對色、配色微調用得到。CIEDE2000 公式出名難算,已用 Sharma 等人(2005)標準測試資料逐筆驗證。全程在你瀏覽器計算,不連網、不上傳。',
    keywords: [
      '色差',
      'delta e',
      'deltae',
    ...
    icon: '🎯',
    loader: () => import('@/tools/delta-e/Index.vue'),
  },
  {
    id: 'oklch-convert',
    name: 'OKLCH / OKLab 轉換',
    category: 'workshop',
    description:
      'HEX/RGB ↔ OKLCH 雙向轉換,還能直接拉明度 L、彩度 C、色相 H 三條滑桿即時調色。OKLCH 是 CSS Color 4 的現代色彩空間,感知均勻、調色不偏色,做漸層、色階、無障礙配色比 HSL 自然;會標出超出 sRGB 色域的顏色。矩陣採 Ottosson 公布值並用三原色與往返測試驗證。全程在你瀏覽器計算,不連網、不上傳。',
    keywords: [
      'oklch',
      'oklab',
      'okhsl',
    ...
    icon: '🌐',
    loader: () => import('@/tools/oklch-convert/Index.vue'),
  },
  {
    id: 'color-temp',
    name: '色溫(Kelvin)↔ 顏色',
    category: 'workshop',
    description:
      '把光源色溫(克氏溫度 K)換成螢幕可顯示的 sRGB 顏色,也能由顏色反查最接近的色溫。低色溫偏紅黃(暖)、高色溫偏藍(冷);附燭光、暖白燈泡、日光、D65、陰天等常見光源快選與 mired 換算。選燈泡、攝影白平衡、UI 模擬光線色調用得到。採 Tanner Helland 近似式,全程在你瀏覽器計算,不連網、不上傳。',
    keywords: [
      '色溫',
      '色温',
      'kelvin',
    ...
    icon: '🌡️',
    loader: () => import('@/tools/color-temp/Index.vue'),
  },
  {
    id: 'note-freq',
    name: '音名 / 頻率 / MIDI 換算',
    category: 'workshop',
    description:
      '音名(C4、A#5、Bb3)↔ 頻率(Hz)↔ MIDI 編號互轉,標準音 A4 可調(440/442/古樂 415)。也能由任意頻率反查最接近的音與偏差音分(cents)當調音器,並列出整段音域對照表、用 Web Audio 試聽。十二平均律,中央 C = C4。作曲、編曲、樂器調音、音訊程式開發用得到。全程在你瀏覽器計算,不連網、不上傳。',
    keywords: [
      '音名',
      '頻率',
      'hz',
    ...
    icon: '🎵',
    loader: () => import('@/tools/note-freq/Index.vue'),
  },
  {
    id: 'bpm-delay',
    name: 'BPM 節拍 / 延遲時間計算',
    category: 'workshop',
    description:
      '由速度(BPM)算出各種音符的時長(毫秒)與對應頻率(Hz),含直音 / 附點 / 三連音,用來設定 delay 延遲、reverb 殘響、LFO 速率與節奏同步;附 tap tempo 打點測速。音樂製作、編曲、混音用得到。全程在你瀏覽器計算,不連網、不上傳。',
    keywords: [
      'bpm',
      '節拍',
      '拍速',
    ...
    icon: '🥁',
    loader: () => import('@/tools/bpm-delay/Index.vue'),
  },
  {
    id: 'type-scale',
    name: '字級比例 / Type Scale 產生器',
    category: 'workshop',
    description:
      '用一個基準字級 + 比例(小三度 1.2、大三度 1.25、完全五度 1.5、黃金比例 1.618…),產生一整套和諧、有層次的字級,即時預覽各階大小並輸出 px / rem 與 CSS 自訂屬性。網頁與平面排版常用的模組化比例做法,做設計系統字級階層用得到。全程在你瀏覽器計算,不連網、不上傳。',
    keywords: [
      '字級',
      '字級比例',
      'type scale',
    ...
    icon: '🔠',
    loader: () => import('@/tools/type-scale/Index.vue'),
  },
  {
    id: 'fraction',
    name: '分數 / 小數 / 百分比互轉',
    category: 'workshop',
    description:
      '分數約分(最簡分數)、假分數 ↔ 帶分數、分數 ↔ 小數 ↔ 百分比互轉,並支援「循環小數精確轉分數」(0.1(6)=1/6、0.(142857)=1/7,不是近似)與「小數用連分數近似成分數」(π≈355/113)。分數轉小數會自動標出循環節。數學作業、食譜比例、英制尺寸、工程估算用得到。全程在你瀏覽器計算,不連網、不上傳。',
    keywords: [
      '分數',
      '約分',
      '最簡分數',
    ...
    icon: '➗',
    loader: () => import('@/tools/fraction/Index.vue'),
  },
  {
    id: 'resistor',
    name: '電阻色環計算器',
    category: 'workshop',
    description:
      '電阻色環 ↔ 阻值雙向換算:選 4 / 5 / 6 環顏色即時讀出阻值、誤差、溫度係數與容許範圍;也能反過來由阻值產生對應色環,並解析 SMD 表面黏著電阻數字碼(472、4702、4R7)。附電阻外觀示意。IEC 60062 標準色碼。電子 DIY、修電路、Arduino/樹莓派玩家用得到。全程在你瀏覽器計算,不連網、不上傳。',
    keywords: [
      '電阻',
      '色環',
      '色碼',
    ...
    icon: '🔌',
    loader: () => import('@/tools/resistor/Index.vue'),
  },
  {
    id: 'ua-parser',
    name: 'User-Agent 解析器',
  ...
  },
  {
    ...
    category: 'life',
    description:
      '打電話跟銀行 / 客服報帳號、確認碼、訂單號時,B/D、M/N、1/7 很容易聽錯 —— 這支把每個字逐字拆成「怎麼念」,照著念對方一聽就懂。台灣電話報號用熟悉口語(0 洞、1 么、2 兩、7 拐、9 勾),國際 NATO 用 Alpha / Bravo;也能反向把對方念的「Alpha Bravo」或「洞么拐」還原回字串。純文字處理,全程在你瀏覽器,不連網、不上傳。',
    keywords: [
      '拼讀',
      '報號',
      '電話報號',
    ...
    icon: '🔤',
    loader: () => import('@/tools/phonetic-spell/Index.vue'),
  },
  {
    id: 'cipher-classic',
    name: '古典密碼',
    category: 'life',
    description:
      '凱撒位移 / ROT13 / ROT47 / Atbash / Vigenère / A1Z26 等古典替換式密碼的編解碼,凱撒還能一次列出全部 25 種位移暴力破解。教學、解謎、密室逃脫、CTF 用;古典密碼極易破解、非安全加密。全程在你瀏覽器計算,不連網、不上傳。',
    keywords: [
      '密碼',
      '古典密碼',
      '凱撒',
    ...
    icon: '🔡',
    loader: () => import('@/tools/cipher-classic/Index.vue'),
  },
  {
    id: 'sudoku',
    name: '數獨解題 / 出題',
    category: 'life',
    description:
      '貼上或輸入卡關的數獨,瞬間解出答案,並判斷是無解、唯一解還是多組解;也能一鍵出題(簡單/中等/困難),每題都驗證過「保證唯一解」。回溯法 + 最少候選優先,輸入時即時標出衝突的格子。全程在你瀏覽器運算,不連網、不上傳。',
    keywords: [
      '數獨',
      'sudoku',
      '解數獨',
    ...
    icon: '🔢',
    loader: () => import('@/tools/sudoku/Index.vue'),
  },
  {
    id: 'combinatorics',
    name: '排列組合 / 機率計算',
    category: 'life',
    description:
      '算排列 P(n,r)、組合 C(n,r)、階乘 n!、可重複排列 nʳ、可重複組合,以及樂透中頭獎機率(內建大樂透/威力彩/今彩 539)。全部用 BigInt 精確計算,連 100! 這種大數也不失準。數學作業、抽獎/分組算法、樂透機率用得到。全程在你瀏覽器計算,不連網、不上傳。',
    keywords: [
      '排列',
      '組合',
      '排列組合',
    ...
    icon: '🎲',
    loader: () => import('@/tools/combinatorics/Index.vue'),
  },
  {
    id: 'number-theory',
    name: '數論工具箱 / 質因數分解',
    category: 'life',
    description:
      '輸入一個整數,立刻算出質因數分解(360 = 2³×3²×5)、是不是質數、所有因數、因數個數 τ、因數總和 σ、歐拉函數 φ、上一個/下一個質數、是虧數/完美數/盈數;另可一次算多個數的最大公因數(GCD)與最小公倍數(LCM)。全部用 BigInt 精確計算,連上百位大數也不失準。數學作業、加密學習、約分通分用得到。全程在你瀏覽器計算,不連網、不上傳。',
    keywords: [
      '數論',
      '質因數分解',
      '質因數',
