...
export const tools: ToolDef[] = [
  ...
  },
  {
    ...
    name: 'PDF 工坊',
    category: 'workshop',
    description: '合併、刪頁/重排、圖片↔PDF、取出文字、加浮水印、加頁碼、併頁省紙、壓縮 —— 全程在你瀏覽器處理,不上傳機密文件、無廣告、不限檔數。',
    keywords: ['pdf', '合併', '分割', '刪頁', '重排', '旋轉', '轉正', '轉向', '歪斜', '頁面', '圖片轉pdf', 'pdf轉圖片', 'pdf轉jpg', '掃描', '轉檔', '擷取', '抽頁', '組合', '浮水印', '加註', '證件', '防盜用', 'watermark', '取出文字', '抽文字', '複製文字', '純文字', 'pdf轉文字', 'pdf轉文字檔', '文字層', '頁碼', '加頁碼', '編號', '頁數', '第幾頁', 'page number', '併頁', '省紙', '一頁多頁', '2合1', '4合1', '多合一', '講義', '印講義', 'n-up', 'nup', '節省紙張', '壓縮', '縮小', '減肥', '檔案太大', '太大', '寄不出去', 'compress', '變小'],
    icon: '📄',
